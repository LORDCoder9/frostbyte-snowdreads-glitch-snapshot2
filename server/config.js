module.exports = {
    ...
    host: "snowdreads-demo.glitch.me",
    ...
    WELCOME_MESSAGE: "You have spawned! Welcome to the game.\n"
                    ...
                    +"Press 'p' to access the developer menu, no token required.",
    ...
    FOOD_SPAWN_CHANCE: 0, // Likeliness of normal food spawn attempts succeedingg.
    ...
    FOOD_SPAWN_CHANCE_NEST: 0, // Likeliness of nest food spawn attempts succeeding.
